...
#include "../hpp/analysis_manager.hpp"  // Include the new analysis manager
...
int main()
{
    try
    {
        ...
        // Initialize the new AnalysisManager for 3D visualizations
        AnalysisManager analysis_manager;

        // Create test data - sorted array for binary search (larger for more meaningful data)
        std::vector<int> sorted_array;
        for (int i = 0; i < 200000; i += 1)  // Increased to 200K for more meaningful data
        {
            sorted_array.push_back(i);
        }

        // Run multiple binary searches and monitor resources
        std::vector<int> targets = {10000, 50000, 100000, 150000, 199999};
        ...
        std::vector<int> quick_sort_sizes = {5000, 10000, 15000, 20000, 25000};
        ...
        std::vector<int> merge_sort_sizes = {5000, 10000, 15000, 20000, 25000};
        ...
        std::vector<int> fib_values = {30, 35, 40, 45, 50};  // Higher values for more computation
        ...
        // Keep sizes reasonable since bubble sort is O(n²)
        std::vector<int> bubble_sort_sizes = {1000, 1500, 2000, 2500, 3000};
        ...
        std::vector<int> heap_sort_sizes = {5000, 10000, 15000, 20000, 25000};
        ...
        std::vector<int> insertion_sort_sizes = {2000, 3000, 4000, 5000, 6000};
        ...
        // Generate 3D visualizations for Binary Search using AnalysisManager
        std::cout << "Generating 3D analysis for Binary Search..." << std::endl;
        analysis_manager.perform_analysis("binary_search_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Linear Search
        std::cout << "Generating 3D analysis for Linear Search..." << std::endl;
        analysis_manager.perform_analysis("linear_search_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Quick Sort
        std::cout << "Generating 3D analysis for Quick Sort..." << std::endl;
        analysis_manager.perform_analysis("quick_sort_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Merge Sort
        std::cout << "Generating 3D analysis for Merge Sort..." << std::endl;
        analysis_manager.perform_analysis("merge_sort_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Bubble Sort
        std::cout << "Generating 3D analysis for Bubble Sort..." << std::endl;
        analysis_manager.perform_analysis("bubble_sort_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Heap Sort
        std::cout << "Generating 3D analysis for Heap Sort..." << std::endl;
        analysis_manager.perform_analysis("heap_sort_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Insertion Sort
        std::cout << "Generating 3D analysis for Insertion Sort..." << std::endl;
        analysis_manager.perform_analysis("insertion_sort_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Fibonacci
        std::cout << "Generating 3D analysis for Fibonacci..." << std::endl;
        analysis_manager.perform_analysis("fibonacci_iterative_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        // Generate 3D visualizations for Interpolation Search
        std::cout << "Generating 3D analysis for Interpolation Search..." << std::endl;
        analysis_manager.perform_analysis("interpolation_search_" + timestamp, []() {
            // Empty function since data is already collected
        });
        ...
        std::cout << "- Both traditional 2D plots and enhanced 3D visualizations created" << std::endl;
    }
