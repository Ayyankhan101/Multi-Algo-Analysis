...
set output 'png/fibonacci_iterative_20260131_225122_performance.png'
...
plot 'png/fibonacci_iterative_20260131_225122_performance.dat' using 1:2 with linespoints ls 1 title 'CPU %'
set title 'Memory Usage (MB)'
set xlabel 'Time'
set ylabel 'Memory (MB)'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/fibonacci_iterative_20260131_225122_performance.dat' using 1:3 with linespoints ls 2 title 'Memory'
set title 'Execution Time (s)'
set xlabel 'Time'
set ylabel 'Execution Time (s)'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/fibonacci_iterative_20260131_225122_performance.dat' using 1:8 with linespoints ls 3 title 'Exec Time'
...
plot 'png/fibonacci_iterative_20260131_225122_performance.dat' using 1:9 with linespoints ls 4 title 'Threads'
unset multiplot
