...
set output 'png/binary_search_20260131_225833_3d_enhanced_3d_surface.png'
...
splot 'png/binary_search_20260131_225833_3d_enhanced_3d.dat' using 1:2:3 with linespoints linewidth 2 pointtype 7 pointsize 0.8 title 'Performance Evolution'

# Set output for trajectory view
set output 'png/binary_search_20260131_225833_3d_enhanced_3d_trajectory.png'
set title 'Performance Trajectory Over Time' font 'Helvetica,16'
splot 'png/binary_search_20260131_225833_3d_enhanced_3d.dat' using 1:2:3 with lines linewidth 3 lc rgb '#F18F01' title 'Performance Path'

# Set output for top-down view
set output 'png/binary_search_20260131_225833_3d_enhanced_3d_topview.png'
set title 'Performance Map (Top View)' font 'Helvetica,16'
set view map
set pm3d map
plot 'png/binary_search_20260131_225833_3d_enhanced_3d.dat' using 1:2:3 with points palette pointtype 7 pointsize 1.2 title 'Resource Distribution'
