...
set output 'png/bubble_sort_20260131_225833_algorithm.png'
...
plot 'png/bubble_sort_20260131_225833_algorithm.dat' using 1:11 with linespoints ls 1 title 'Cache Hit Rate'
set title 'Error Rate (%)'
set xlabel 'Time'
set ylabel 'Error Rate %'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/bubble_sort_20260131_225833_algorithm.dat' using 1:12 with linespoints ls 2 title 'Error Rate'
set title 'Throughput (ops/sec)'
set xlabel 'Time'
set ylabel 'Operations/sec'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/bubble_sort_20260131_225833_algorithm.dat' using 1:13 with linespoints ls 3 title 'Throughput'
...
plot 'png/bubble_sort_20260131_225833_algorithm.dat' using 1:14 with lines ls 1 title 'P50', \
     'png/bubble_sort_20260131_225833_algorithm.dat' using 1:15 with lines ls 2 title 'P95', \
     'png/bubble_sort_20260131_225833_algorithm.dat' using 1:16 with lines ls 3 title 'P99'
unset multiplot
