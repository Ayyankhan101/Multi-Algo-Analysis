...
set output 'png/binary_search_20260131_225833_resources.png'
...
plot 'png/binary_search_20260131_225833_resources.dat' using 1:4 with linespoints ls 1 title 'Disk Read'
set title 'Disk Write I/O (MB/s)'
set xlabel 'Time'
set ylabel 'Write MB/s'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/binary_search_20260131_225833_resources.dat' using 1:5 with linespoints ls 2 title 'Disk Write'
set title 'Network Input (MB/s)'
set xlabel 'Time'
set ylabel 'Input MB/s'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/binary_search_20260131_225833_resources.dat' using 1:6 with linespoints ls 3 title 'Network In'
...
plot 'png/binary_search_20260131_225833_resources.dat' using 1:7 with linespoints ls 4 title 'Network Out'
unset multiplot
