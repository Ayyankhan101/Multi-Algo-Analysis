...
set output 'png/binary_search_20260131_224634.png'
...
plot 'png/binary_search_20260131_224634.dat' using 1:2 with linespoints ls 1 title 'CPU Time'
set title 'Memory Usage'
set xlabel 'Time'
set ylabel 'Memory (KB)'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/binary_search_20260131_224634.dat' using 1:3 with linespoints ls 2 title 'Memory Usage'
set title 'Execution Time'
set xlabel 'Time'
set ylabel 'Execution Time (seconds)'
set grid linestyle 1 lc rgb '#D3D3D3' lt 0 lw 1
set border linewidth 1.5
plot 'png/binary_search_20260131_224634.dat' using 1:4 with linespoints ls 3 title 'Execution Time'
...
plot 'png/binary_search_20260131_224634.dat' using 1:2 with lines ls 1 title 'CPU Time', \
     'png/binary_search_20260131_224634.dat' using 1:3 with lines ls 2 title 'Memory', \
     'png/binary_search_20260131_224634.dat' using 1:4 with lines ls 3 title 'Exec Time'
unset multiplot
